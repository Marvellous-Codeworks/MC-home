...
function TmsPage() {
  ...
  const features: Array<{ title: string; body: string; icon: LucideIcon }> = [
    { title: t("tms.f1.t"), body: t("tms.f1.b"), icon: SlidersHorizontal },
    { title: t("tms.f2.t"), body: t("tms.f2.b"), icon: RotateCcw },
    { title: t("tms.f3.t"), body: t("tms.f3.b"), icon: Zap },
  ];
